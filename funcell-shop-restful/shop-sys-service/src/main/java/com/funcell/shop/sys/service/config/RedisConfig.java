...
import com.funcell.shop.sys.service.common.constant.GlobalConstant;
import com.funcell.shop.sys.service.support.redis.RedisHelper;
 ...
 */
@Configuration
@ConfigurationProperties(prefix = "funcell.redis")
@EnableCaching
