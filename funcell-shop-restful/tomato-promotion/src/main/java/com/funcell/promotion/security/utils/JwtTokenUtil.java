package com.funcell.promotion.security.utils;

import com.funcell.promotion.security.properties.JwtConfigProperties;
...
//            username = claims.getSubject();
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        TomatoUserEntity user = (TomatoUserEntity) userDetails;
