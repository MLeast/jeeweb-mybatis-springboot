...
import com.funcell.promotion.common.properties.PddProperties;
import com.funcell.promotion.moudle.entity.SubjectEntity;
import com.funcell.promotion.moudle.service.IPddService;
import com.funcell.promotion.moudle.service.ISubjectService;
...
public class PddServiceImpl implements IPddService {
    ...
    public String categoryProduct(JSONObject json) {
        ...
        Log.i("opt_id:" + optId + ",page:" + page + ",page_size:" + page_size);
    ...
    private String getResponse(List<String> productList, int page, int pageSize) {
        ...
        if (productList.size() <= pageSize) {
            ...
            //继续往下滑当
            if (page * pageSize > productList.size()) {//当前页数已超总额
                return "";
            }
    ...
    private String getProductList(List<String> productList, int page, int pageSize) {
        ...
        Log.i("getProductList,response:" + response);
    ...
    private SubjectEntity getSubjectByWeight(List<SubjectEntity> subjectList) {
        ...
        for (SubjectEntity subjectEntity : subjectList) {
            ...
            if (DateUtils.isNotOneDay(new Date(), endDate) > 0 && subjectEntity.getSubject_weight() > TomatoConstant.Common.NUMBER_0) {
        ...
        Log.i("This Random number is " + randomWeight);
