...
-----------------------------------
```
manerger-sys-common 后台管理系统公用模块
    manerger-sys-common-base 基础模块
    manerger-sys-common-email 邮件模块
    manerger-sys-common-mybatis 数据库操作模块、Mybatis-plus
    manerger-sys-common-oss 附件上传模块
    manerger-sys-common-quartz 任务模块
    manerger-sys-common-query 参数封装模块
    manerger-sys-common-security 鉴权模块
    manerger-sys-common-sms  短信模块
    manerger-sys-common-utils 工具模块
    manerger-sys-common-limit 限流模块
    manerger-sys-common-lock 分布式锁模块
    manerger-sys-common-idgenerator id生成模块
    manerger-sys-common-queue 排队模块
manerger-sys-service 后台管理模块
tomato-promotion 业务系统模块
```
系统演示
-----------------------------------
