...
import com.funcell.manerger.sys.common.query.data.Page;
import com.funcell.manerger.sys.common.query.data.PageImpl;
...
import com.funcell.manerger.sys.service.modules.sys.entity.UserOnline;
import com.funcell.manerger.sys.service.security.shiro.session.mgt.OnlineSession;
 ...
 */
@Controller
@RequestMapping(value = "${funcell.admin.url.prefix}/sys/online")
