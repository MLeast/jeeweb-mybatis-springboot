package com.funcell.manerger.sys.ui.tag.grid;
...
import com.funcell.manerger.sys.common.utils.Reflections;
import com.funcell.manerger.sys.common.utils.SpringContextHolder;
import com.funcell.manerger.sys.common.utils.StringUtils;
import com.funcell.manerger.sys.common.utils.fastjson.FastjsonPropertyPreFilter;
import com.funcell.manerger.sys.common.utils.fastjson.FastjsonUnXssFilter;
...
import com.funcell.manerger.sys.ui.tag.tag.AbstractGridHtmlTag;
...
//	private String sortname = "id";
	...
	private Boolean treeGrid = Boolean.FALSE;// 是否树机构
...
//		rootMap.put("staticPath", staticPath);
		...
		if (datas != null) {
			...
			if (dataList != null && dataList.size() > 0) {
				...
				FastjsonPropertyPreFilter fastjsonPropertyPreFilter = new FastjsonPropertyPreFilter(clazz, properties);
