package com.funcell.manerger.sys.ui.tag.html.builder;
...
import com.funcell.manerger.sys.ui.tag.html.exception.HtmlComponentException;
import com.funcell.manerger.sys.ui.tag.html.resolver.HtmlComponentDTDEntityResolver;
...
public class DefaultHtmlComponentBuilder implements HtmlComponentBuilder, ResourceLoaderAware {
	...
	private void buildMap(Resource resource) {
		try {
			Document document = read(resource.getInputStream());
