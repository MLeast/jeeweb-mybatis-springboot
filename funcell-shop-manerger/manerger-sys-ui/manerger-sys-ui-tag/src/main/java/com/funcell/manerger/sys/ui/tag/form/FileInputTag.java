package com.funcell.manerger.sys.ui.tag.form;
...
import com.funcell.manerger.sys.ui.beetl.tag.form.HiddenInputTag;
...
public class FileInputTag extends HiddenInputTag {
	...
	protected String uploadSuccessCallback = ""; // 上传成功回调idField
	...
	protected String idFieldValue = "";//id值
...
//		rootMap.put("staticPath", staticPath);
		...
		rootMap.put("idFieldValue",idFieldValue);
