...
public abstract class AbstractCheckedElementTag extends AbstractHtmlInputElementTag {
	 ...
	 * through delegating to {@link com.funcell.manerger.sys.ui.beetl.tag.form.SelectedValueComparator#isSelected}.
	 */
	private boolean isOptionSelected(Object value) throws BeetlTagException {
		return com.funcell.manerger.sys.ui.beetl.tag.form.SelectedValueComparator.isSelected(getBindStatus(), value);
	}
