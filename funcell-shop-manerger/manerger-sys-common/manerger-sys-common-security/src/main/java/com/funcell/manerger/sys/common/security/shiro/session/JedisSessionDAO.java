package com.funcell.manerger.sys.common.security.shiro.session;

import com.funcell.manerger.sys.common.utils.DateUtils;
import com.funcell.manerger.sys.common.utils.JedisUtils;
...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO {
	...
	public void update(Session session) throws UnknownSessionException {
		 ...
		 * PropertiesUtil.getConfig("web.view.prefix")) &&
		 * StringUtils.endsWith(uri,
		 * PropertiesUtil.getConfig("web.view.suffix"))) { return; } //
		 * 手动控制不更新SESSION if
