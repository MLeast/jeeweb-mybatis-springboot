package com.funcell.manerger.sys.common.idgenerator.redis.impl;

import com.funcell.manerger.sys.common.idgenerator.exception.IdGeneratorException;
...
public class RedisIdGeneratorImpl implements RedisIdGenerator {
    ...
    public String nextUniqueId(String compositeKey, int step, int length, boolean useHashIds, String salt) throws Exception {
        ...
        builder.append(com.funcell.manerger.sys.common.idgenerator.redis.utils.StringUtils.formatString((long) value3, length, DECIMAL_FORMAT));
