package com.funcell.manerger.sys.common.idgenerator.local.utils;
...
public class SnowflakeIdGenerator {
    ...
    public SnowflakeIdGenerator(long startTimestamp, long dataCenterId, long machineId) {
        ...
        if (startTimestamp > currentTimestamp) {
            throw new IdGeneratorException(String.format("Start timestamp can't be greater than %d", currentTimestamp));
        }
