package com.funcell.manerger.sys.common.quartz.config;

import com.funcell.manerger.sys.common.quartz.QuartzManager;
import com.funcell.manerger.sys.common.quartz.callback.QuartzInitCallback;
...
public class QuartzConfig implements ApplicationRunner {
    ...
    public SchedulerFactoryBean schedulerFactoryBean(DataSource dataSource) throws IOException {
        ...
        schedulerFactoryBean.setSchedulerName("FuncellWebScheduler");
        // 启动时延期1秒开始任务
