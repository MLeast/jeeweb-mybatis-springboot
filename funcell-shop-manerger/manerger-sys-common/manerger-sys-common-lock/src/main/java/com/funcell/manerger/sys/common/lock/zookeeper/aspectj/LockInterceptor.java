package com.funcell.manerger.sys.common.lock.zookeeper.aspectj;

import com.funcell.manerger.sys.common.lock.LockExecutor;
import com.funcell.manerger.sys.common.lock.annotation.Lock;
import com.funcell.manerger.sys.common.lock.enums.LockType;
import com.funcell.manerger.sys.common.lock.zookeeper.condition.ZookeeperLockCondition;
import com.funcell.manerger.sys.common.lock.zookeeper.curator.exception.CuratorException;
...
public class LockInterceptor {
    ...
    @Pointcut(value = "@annotation(com.funcell.manerger.sys.common.lock.annotation.Lock)")
