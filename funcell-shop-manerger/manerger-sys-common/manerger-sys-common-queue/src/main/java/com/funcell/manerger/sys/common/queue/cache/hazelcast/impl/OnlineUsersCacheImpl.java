package com.funcell.manerger.sys.common.queue.cache.hazelcast.impl;

import com.funcell.manerger.sys.common.queue.cache.hazelcast.IHazelcastCacheBean;
...
@Service
public class OnlineUsersCacheImpl implements IHazelcastCacheBean {
    @Autowired
